...
(function() {
    ...
    let reported = false;
    let relayed = false;
    const TRUSTED_PLAYER_ORIGIN = /https:\/\/(?:[^/]+\.)?(pornhoarder\.(?:io|net|pictures)|filemoon\.sx|dood\.(?:re|wf|cx|sh)|doodstream\.com|voe\.sx|(?:[^/]+\.)?streamtape\.com|(?:[^/]+\.)?lulustream\.com|(?:[^/]+\.)?netu\.ac|bigwarp\.io|398fitus\.com)(?::\d+)?$/i;
